    ...
    public class PhoneBookWebApiModule : AbpModule
    {
        ...
        private void ConfigureSwaggerUi()
        {
            Configuration.Modules.AbpWebApi().HttpConfiguration
                .EnableSwagger(c =>
                {
                    c.SingleApiVersion("v1", "SSoft.PhoneBook.WebApi");
                    c.ResolveConflictingActions(apiDescriptions => apiDescriptions.First());
                })
                .EnableSwaggerUi(c =>
                {
                    c.InjectJavaScript(Assembly.GetAssembly(typeof(PhoneBookWebApiModule)), "SSoft.PhoneBook.WebApi.Scripts.Swagger-Custom.js");
                });
        }
    }
}
