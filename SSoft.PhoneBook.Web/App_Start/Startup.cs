...
using SSoft.PhoneBook.Web;
using SSoft.PhoneBook.Web.Auth;
using SSoft.PhoneBook.WebApi.Controllers;
using Owin;
...
namespace SSoft.PhoneBook.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //Enable it to use HangFire dashboard (uncomment only if it's enabled in PhoneBookWebModule)
