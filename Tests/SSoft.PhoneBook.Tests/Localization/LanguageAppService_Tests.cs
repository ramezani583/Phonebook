...
using SSoft.PhoneBook.Localization;
using SSoft.PhoneBook.Localization.Dto;
using SSoft.PhoneBook.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace SSoft.PhoneBook.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = PhoneBookConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
