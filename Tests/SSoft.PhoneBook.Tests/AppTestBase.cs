...
using SSoft.PhoneBook.Tests.TestDatas;
...
namespace SSoft.PhoneBook.Tests
{
    ...
    /// Provides methods to easily work with <see cref="PhoneBookDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase<PhoneBookTestModule>
    {
