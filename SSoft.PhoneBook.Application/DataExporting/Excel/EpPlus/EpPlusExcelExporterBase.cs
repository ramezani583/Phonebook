...
using SSoft.PhoneBook.Net.MimeTypes;
using OfficeOpenXml;

namespace SSoft.PhoneBook.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : PhoneBookServiceBase, ITransientDependency
    {
