...
using SSoft.PhoneBook.Organizations.Dto;
using System.Linq.Dynamic;

namespace SSoft.PhoneBook.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : PhoneBookAppServiceBase, IOrganizationUnitAppService
    {
