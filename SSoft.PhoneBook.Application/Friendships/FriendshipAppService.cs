...
using SSoft.PhoneBook.Friendships.Dto;

namespace SSoft.PhoneBook.Friendships
{
    [AbpAuthorize]
    public class FriendshipAppService : PhoneBookAppServiceBase, IFriendshipAppService
    {
